...
import com.pouillos.monpilulier.entities.AssociationUtilisateurEtablissement;
...
public class AfficherEtablissementActivity extends NavDrawerActivity implements Serializable, BasicUtils, AdapterView.OnItemClickListener {

    @State
    Etablissement etablissementSelected;

    List<Etablissement> listEtablissementsBD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AfficherEtablissementActivity.AsyncTaskRunner runner = new AfficherEtablissementActivity.AsyncTaskRunner();
        runner.execute();
    ...
    public void traiterIntent() {
        ...
        if (intent.hasExtra("etablissementId")) {
            ...
            etablissementSelected = Etablissement.findById(Etablissement.class, etablissementId);
            int position = 0;
            for (Etablissement etablissement : listEtablissementsBD) {
                if (etablissement.getId().longValue() != etablissementId) {
                    position ++;
                } else {
                    break;
                }
            ...
            selectedEtablissement.setText(selectedEtablissement.getAdapter().getItem(position).toString(), false);
    ...
    public class AsyncTaskRunner extends AsyncTask<Void, Integer, Void> {
        ...
        protected Void doInBackground(Void...voids) {
            ...
            publishProgress(10);
            String requete = "";
            listEtablissementsBD = new ArrayList<>();
            ...
            listEtablissementsBD = Etablissement.findWithQuery(Etablissement.class, requete);
            publishProgress(100);
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (listEtablissementsBD.size() == 0) {
                Toast.makeText(AfficherEtablissementActivity.this, R.string.text_no_matching, Toast.LENGTH_LONG).show();
                listEtablissements.setVisibility(View.GONE);
            } else {
                buildDropdownMenu(listEtablissementsBD, AfficherEtablissementActivity.this,selectedEtablissement);
    ...
    public void fabSaveClick() {
        ...
        Toast.makeText(AfficherEtablissementActivity.this, "à implementer 5a", Toast.LENGTH_LONG).show();
        if (checkFields()) {
        ...
        displayAllFields(false);
        displayFabs();
        Toast.makeText(AfficherEtablissementActivity.this, R.string.modification_saved, Toast.LENGTH_LONG).show();
    ...
    public void fabDeleteClick() {
        ...
        deleteItem(AfficherEtablissementActivity.this, association, AfficherEtablissementActivity.class,true);
    }

    @Override
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        etablissementSelected = listEtablissementsBD.get(position);
        clearAllFields();
        enableFields(false);
        displayFabs();
        fillAllFields();
