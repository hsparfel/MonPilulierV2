...
import com.pouillos.monpilulier.views.viewholder.ListAllMedicamentViewHolder;
            ...
            holder.itemView.findViewById(R.id.buttonModify).setOnClickListener(
                    new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            newMedicamentActivity.putExtra("medicamentAModifId", medicament.getId());
                    ...
                    new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            new AlertDialog.Builder(v.getContext())
                                    ...
                                    .setMessage("Etes vous sûr de vouloir supprimer le medicament "+medicament.afficherTitre()+" ?")
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    new AlertDialog.Builder(holder.itemView.getContext())
                            .setTitle(medicament.afficherTitre())
                            .setMessage(medicament.afficherDetail())
                            .show();
                }
            });
        }
